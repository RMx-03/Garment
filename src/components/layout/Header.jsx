          ...
          <div className="hidden md:block">
            <div className="flex items-center space-x-8">
              ...
              >
                ...
                {showWomenMenu && (
                  <div className="absolute left-0 mt-2 w-screen bg-white border-t border-gray-200 shadow-lg z-50">
                    <div className="max-w-7xl mx-auto px-8 py-6 grid grid-cols-2 gap-x-8">
                      <div>
                        <h3 className="text-gray-500 text-sm font-medium mb-4">HIGHLIGHTS</h3>
                        <ul className="space-y-4">
                          {womenCategories.highlights.map((item) => (
                            <li key={item.name}>
                              <Link to={item.link} className="text-gray-700 hover:text-black">
                                {item.name}
                              </Link>
                            </li>
                          ))}
